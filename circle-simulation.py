...
def create_frame(step):
    ...
    # Draw cylinder
    circle = plt.Circle((cylinder_x, cylinder_y), cylinder_r, 
...
def simulate():
    ...
    # Simulation parameters
    max_steps = 1000  # Reduced for reasonable gif size
